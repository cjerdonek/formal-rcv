...
_N__even n =
  case n of {
   ...
   BinNums.Npos p ->
    case p of {
     BinNums.Coq_xO p0 -> Prelude.True;
     _ -> Prelude.False}}
...
_N__pos_div_eucl :: BinNums.Coq_positive -> BinNums.N -> (,) BinNums.N
                    BinNums.N
_N__pos_div_eucl a b =
  case a of {
   ...
   BinNums.Coq_xH ->
    case b of {
     BinNums.N0 -> (,) BinNums.N0 (BinNums.Npos BinNums.Coq_xH);
     BinNums.Npos p ->
      case p of {
       BinNums.Coq_xH -> (,) (BinNums.Npos BinNums.Coq_xH) BinNums.N0;
       _ -> (,) BinNums.N0 (BinNums.Npos BinNums.Coq_xH)}}}
...
_N__ggcd a b =
  case a of {
   BinNums.N0 -> (,) b ((,) BinNums.N0 (BinNums.Npos BinNums.Coq_xH));
   BinNums.Npos p ->
    case b of {
     BinNums.N0 -> (,) a ((,) (BinNums.Npos BinNums.Coq_xH) BinNums.N0);
     BinNums.Npos q ->
      case BinPos._Pos__ggcd p q of {
       (,) g p0 ->
        case p0 of {
         (,) aa bb -> (,) (BinNums.Npos g) ((,) (BinNums.Npos aa)
          (BinNums.Npos bb))}}}}
...
_N__testbit_nat :: BinNums.N -> Datatypes.Coq_nat -> Prelude.Bool
_N__testbit_nat a =
  case a of {
   BinNums.N0 -> (\x -> Prelude.False);
...
_N__eq_dec n m =
  BinNums.coq_N_rec (\m0 ->
    case m0 of {
     BinNums.N0 -> Prelude.True;
     BinNums.Npos p -> Prelude.False}) (\p m0 ->
    case m0 of {
     BinNums.N0 -> Prelude.False;
     BinNums.Npos p0 ->
      Specif.sumbool_rec (\_ -> Logic.eq_rec_r p0 Prelude.True p) (\_ ->
        Prelude.False) (BinPos._Pos__eq_dec p p0)}) n m

_N__discr :: BinNums.N -> Prelude.Maybe BinNums.Coq_positive
_N__discr n =
  case n of {
...
_N__Private_Dec__max_dec n m =
  _N__Private_Dec__max_case n m (\x y _ h0 -> h0) Prelude.True Prelude.False
...
_N__Private_Dec__min_dec n m =
  _N__Private_Dec__min_case n m (\x y _ h0 -> h0) Prelude.True Prelude.False
