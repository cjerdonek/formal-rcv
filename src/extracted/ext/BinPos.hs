...
_Pos__leb :: BinNums.Coq_positive -> BinNums.Coq_positive -> Prelude.Bool
_Pos__leb x y =
  case _Pos__compare x y of {
   Datatypes.Gt -> Prelude.False;
   _ -> Prelude.True}

_Pos__ltb :: BinNums.Coq_positive -> BinNums.Coq_positive -> Prelude.Bool
_Pos__ltb x y =
  case _Pos__compare x y of {
    ...
    case y of {
     Pos__IsPos r ->
      ...
      case _Pos__leb s' r' of {
       Prelude.True -> (,) (BinNums.Coq_xI s) (_Pos__sub_mask r' s');
       Prelude.False -> (,) (BinNums.Coq_xO s) (Pos__IsPos r')};
     _ -> (,) (BinNums.Coq_xO s)
      (_Pos__sub_mask (g (f BinNums.Coq_xH)) (BinNums.Coq_xO (BinNums.Coq_xO
        BinNums.Coq_xH)))}}

_Pos__sqrtrem :: BinNums.Coq_positive -> (,) BinNums.Coq_positive
                 Pos__Coq_mask
_Pos__sqrtrem p =
  case p of {
   BinNums.Coq_xI p0 ->
    case p0 of {
     ...
     BinNums.Coq_xO p1 ->
      _Pos__sqrtrem_step (\x -> BinNums.Coq_xO x) (\x -> BinNums.Coq_xI x)
        (_Pos__sqrtrem p1);
     BinNums.Coq_xH -> (,) BinNums.Coq_xH (Pos__IsPos (BinNums.Coq_xO
      BinNums.Coq_xH))};
   BinNums.Coq_xO p0 ->
    case p0 of {
     BinNums.Coq_xI p1 ->
     ...
     BinNums.Coq_xO p1 ->
      _Pos__sqrtrem_step (\x -> BinNums.Coq_xO x) (\x -> BinNums.Coq_xO x)
        (_Pos__sqrtrem p1);
     BinNums.Coq_xH -> (,) BinNums.Coq_xH (Pos__IsPos BinNums.Coq_xH)};
   BinNums.Coq_xH -> (,) BinNums.Coq_xH Pos__IsNul}
...
_Pos__ggcdn n a b =
  case n of {
   Datatypes.O -> (,) BinNums.Coq_xH ((,) a b);
   Datatypes.S n0 ->
    case a of {
     BinNums.Coq_xI a' ->
      case b of {
       BinNums.Coq_xI b' ->
        case _Pos__compare a' b' of {
         Datatypes.Eq -> (,) a ((,) BinNums.Coq_xH BinNums.Coq_xH);
         Datatypes.Lt ->
          case _Pos__ggcdn n0 (_Pos__sub b' a') a of {
           (,) g p ->
            case p of {
             (,) ba aa -> (,) g ((,) aa (_Pos__add aa (BinNums.Coq_xO ba)))}};
         Datatypes.Gt ->
          case _Pos__ggcdn n0 (_Pos__sub a' b') b of {
           (,) g p ->
            case p of {
             (,) ab bb -> (,) g ((,) (_Pos__add bb (BinNums.Coq_xO ab)) bb)}}};
       BinNums.Coq_xO b0 ->
        case _Pos__ggcdn n0 a b0 of {
         (,) g p ->
          case p of {
           (,) aa bb -> (,) g ((,) aa (BinNums.Coq_xO bb))}};
       BinNums.Coq_xH -> (,) BinNums.Coq_xH ((,) a BinNums.Coq_xH)};
     BinNums.Coq_xO a0 ->
      case b of {
       BinNums.Coq_xI p ->
        case _Pos__ggcdn n0 a0 b of {
         (,) g p0 ->
          case p0 of {
           (,) aa bb -> (,) g ((,) (BinNums.Coq_xO aa) bb)}};
       BinNums.Coq_xO b0 ->
        case _Pos__ggcdn n0 a0 b0 of {
         (,) g p -> (,) (BinNums.Coq_xO g) p};
       BinNums.Coq_xH -> (,) BinNums.Coq_xH ((,) a BinNums.Coq_xH)};
     BinNums.Coq_xH -> (,) BinNums.Coq_xH ((,) BinNums.Coq_xH b)}}
...
_Pos__testbit :: BinNums.Coq_positive -> BinNums.N -> Prelude.Bool
_Pos__testbit p n =
  case p of {
   BinNums.Coq_xI p0 ->
    case n of {
...
_Pos__eq_dec :: BinNums.Coq_positive -> BinNums.Coq_positive -> Prelude.Bool
_Pos__eq_dec x y =
  BinNums.positive_rec (\p h y0 ->
    case y0 of {
     BinNums.Coq_xI p0 ->
      Specif.sumbool_rec (\_ -> Logic.eq_rec_r p0 Prelude.True p) (\_ ->
        Prelude.False) (h p0);
...
_Pos__Private_Dec__max_dec n m =
  _Pos__Private_Dec__max_case n m (\x y _ h0 -> h0) Prelude.True
    Prelude.False
...
_Pos__Private_Dec__min_dec n m =
  _Pos__Private_Dec__min_case n m (\x y _ h0 -> h0) Prelude.True
    Prelude.False
...
_Pos__max_dec :: BinNums.Coq_positive -> BinNums.Coq_positive -> Prelude.Bool
_Pos__max_dec =
...
_Pos__min_dec :: BinNums.Coq_positive -> BinNums.Coq_positive -> Prelude.Bool
_Pos__min_dec =
